...
func TestUpdateUser(t *testing.T) {
		...
		WithHTTPClient(
			newFakeHTTPClient(t, func(t *testing.T, req *http.Request) *http.Response {
				expectRequest(t, http.MethodPut, "http://mf/v1/users/1", func(r io.Reader) {
					expectFromJSON(t, r, &model.UserModificationRequest{
	...
	res, err := client.UpdateUserContext(t.Context(), 1, &model.UserModificationRequest{
		Username: &expected.Username,
		Password: &expected.Password,
	})
	if err != nil {
		...
		WithHTTPClient(
			newFakeHTTPClient(t, func(t *testing.T, req *http.Request) *http.Response {
				expectRequest(t, http.MethodPost, "http://mf/v1/api-keys", func(r io.Reader) {
					expectFromJSON(t, r, &model.APIKeyCreationRequest{
						Description: "desc",
					})
				}, req)
				return jsonResponseFrom(t, http.StatusOK, http.Header{}, expected)
		...
		WithHTTPClient(
			newFakeHTTPClient(t, func(t *testing.T, req *http.Request) *http.Response {
				expectRequest(t, http.MethodPost, "http://mf/v1/categories", func(r io.Reader) {
					expectFromJSON(t, r, &model.CategoryCreationRequest{
						Title: "Example",
					})
				}, req)
				return jsonResponseFrom(t, http.StatusOK, http.Header{}, expected)
...
func TestCreateCategoryWithOptions(t *testing.T) {
	...
	res, err := client.CreateCategoryWithOptionsContext(t.Context(), &model.CategoryCreationRequest{
		Title:        "Example",
		HideGlobally: true,
	})
	if err != nil {
		...
		WithHTTPClient(
			newFakeHTTPClient(t, func(t *testing.T, req *http.Request) *http.Response {
				expectRequest(t, http.MethodPut, "http://mf/v1/categories/1", func(r io.Reader) {
					expectFromJSON(t, r, &model.CategoryModificationRequest{
...
func TestUpdateCategoryWithOptions(t *testing.T) {
	...
	res, err := client.UpdateCategoryWithOptionsContext(t.Context(), 1, &model.CategoryModificationRequest{
		Title:        &expected.Title,
		HideGlobally: &expected.HideGlobally,
	})
	if err != nil {
...
func TestCreateFeed(t *testing.T) {
	...
	id, err := client.CreateFeedContext(t.Context(), &model.FeedCreationRequest{
		FeedURL: "http://example.com",
	})
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)
...
func TestUpdateFeed(t *testing.T) {
	...
	res, err := client.UpdateFeedContext(t.Context(), 1, &model.FeedModificationRequest{
	...
	client := NewClientWithOptions(
		...
		WithHTTPClient(
			newFakeHTTPClient(t, func(t *testing.T, req *http.Request) *http.Response {
				...
				expectFromJSON(t, req.Body, &model.EntryUpdateRequest{
					Title: &expected.Title,
				})
				return jsonResponseFrom(t, http.StatusOK, http.Header{}, expected)
			})))
	res, err := client.UpdateEntryContext(t.Context(), 1, &model.EntryUpdateRequest{
		Title: &expected.Title,
	})
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)

...
func (c *Client) MeContext(ctx context.Context) (*model.User, error) {
...
func (c *Client) UsersContext(ctx context.Context) (model.Users, error) {
...
func (c *Client) UserByIDContext(ctx context.Context, userID int64) (*model.User, error) {
...
func (c *Client) UserByUsernameContext(ctx context.Context, username string) (*model.User, error) {
...
func (c *Client) CreateUserContext(ctx context.Context, username, password string, isAdmin bool) (*model.User, error) {
	body, err := c.request.Post(ctx, "/v1/users", &model.UserCreationRequest{
		Username: username,
		Password: password,
		IsAdmin:  isAdmin,
	})
...
func (c *Client) UpdateUserContext(ctx context.Context, userID int64, userChanges *model.UserModificationRequest) (*model.User, error) {
...
func (c *Client) APIKeysContext(ctx context.Context) ([]model.APIKey, error) {
...
func (c *Client) CreateAPIKeyContext(ctx context.Context, description string) (*model.APIKey, error) {
	body, err := c.request.Post(ctx, "/v1/api-keys", &model.APIKeyCreationRequest{
...
func (c *Client) CategoriesContext(ctx context.Context) ([]*model.Category, error) {
...
func (c *Client) CategoriesWithCounters() ([]*model.Category, error) {
	ctx, cancel := withDefaultTimeout()
	defer cancel()
...
func (c *Client) CategoriesWithCountersContext(ctx context.Context) ([]*model.Category, error) {
...
func (c *Client) CreateCategoryContext(ctx context.Context, title string) (*model.Category, error) {
	body, err := c.request.Post(ctx, "/v1/categories", &model.CategoryCreationRequest{
		Title: title,
	})
	if err != nil {
		return nil, err
...
func (c *Client) CreateCategoryWithOptionsContext(ctx context.Context, createRequest *model.CategoryCreationRequest) (*model.Category, error) {
...
func (c *Client) UpdateCategoryWithOptionsContext(ctx context.Context, categoryID int64, categoryChanges *model.CategoryModificationRequest) (*model.Category, error) {
...
func (c *Client) CategoryFeedsContext(ctx context.Context, categoryID int64) (model.Feeds, error) {
...
func (c *Client) FeedsContext(ctx context.Context) (model.Feeds, error) {
...
func (c *Client) FeedContext(ctx context.Context, feedID int64) (*model.Feed, error) {
...
func (c *Client) CreateFeedContext(ctx context.Context, feedCreationRequest *model.FeedCreationRequest) (int64, error) {
...
func (c *Client) UpdateFeedContext(ctx context.Context, feedID int64, feedChanges *model.FeedModificationRequest) (*model.Feed, error) {
...
func (c *Client) FeedEntryContext(ctx context.Context, feedID, entryID int64) (*model.Entry, error) {
...
func (c *Client) CategoryEntryContext(ctx context.Context, categoryID, entryID int64) (*model.Entry, error) {
...
func (c *Client) EntryContext(ctx context.Context, entryID int64) (*model.Entry, error) {
...
func (c *Client) UpdateEntryContext(ctx context.Context, entryID int64, entryChanges *model.EntryUpdateRequest) (*model.Entry, error) {
...
// ToggleBookmark toggles the starred flag of an entry.
func (c *Client) ToggleBookmark(entryID int64) error {
	ctx, cancel := withDefaultTimeout()
	defer cancel()
	return c.ToggleBookmarkContext(ctx, entryID)
}

// ToggleBookmarkContext toggles entry starred value.
func (c *Client) ToggleBookmarkContext(ctx context.Context, entryID int64) error {
	_, err := c.request.Put(ctx, fmt.Sprintf("/v1/entries/%d/bookmark", entryID), nil)
	return err
}
...
func (c *Client) FetchCountersContext(ctx context.Context) (*model.FeedCounters, error) {
...
func (c *Client) UpdateEnclosure(entryID, at int64,
	...
	ctx, cancel := withDefaultTimeout()
	defer cancel()
	return c.UpdateEnclosureContext(ctx, entryID, at, data)
}

// UpdateEnclosureContext updates an enclosure.
func (c *Client) UpdateEnclosureContext(ctx context.Context, entryID, enclosureID int64, enclosureUpdate *model.EnclosureUpdateRequest) error {
	_, err := c.request.Put(ctx, fmt.Sprintf("/v1/entries/%d/enclosure/%d", entryID, enclosureID), enclosureUpdate)
	return err
}

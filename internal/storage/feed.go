...
func (s *Storage) CountUserFeedsWithErrors(ctx context.Context, userID int64,
	...
	limit := max(1, config.PollingErrorLimit())
	rows, _ := s.db.Query(ctx, `
...
SET
	...
	password = $11,
	disabled = $12,
	ignore_http_cache = $13,
	allow_self_signed_certificates = $14,
	fetch_via_proxy = $15,
	hide_globally = $16,
	url_rewrite_rules = $17,
	no_media_player = $18,
	apprise_service_urls = $19,
	webhook_url = $20,
	disable_http2 = $21,
	description = $22,
	ntfy_enabled = $23,

...
func TestBlockingEntries(t *testing.T) {
	scenarios := []struct {
		...
		{&model.Feed{ID: 1, Extra: model.FeedExtra{BlockFilterEntryRules: "EntryURL=(?i)example\nEntryTitle=(?i)Test"}}, &model.Entry{URL: "https://example.com", Title: "Some Example"}, &model.User{}, true},
		// Test cases for merged user and feed BlockFilterEntryRules
		{&model.Feed{ID: 1, Extra: model.FeedExtra{BlockFilterEntryRules: "EntryURL=(?i)website"}}, &model.Entry{URL: "https://example.com", Title: "Some Title"}, &model.User{BlockFilterEntryRules: "   EntryTitle=(?i)title   "}, true}, // User rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{BlockFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://example.com", Title: "Some Other"}, &model.User{BlockFilterEntryRules: "EntryTitle=(?i)title"}, true},       // Feed rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{BlockFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://different.com", Title: "Some Other"}, &model.User{BlockFilterEntryRules: "EntryTitle=(?i)title"}, false},    // Neither rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{BlockFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://example.com", Title: "Some Title"}, &model.User{BlockFilterEntryRules: "EntryTitle=(?i)title"}, true},       // Both rules would match
	}
...
func TestAllowEntries(t *testing.T) {
	scenarios := []struct {
		...
		{&model.Feed{ID: 1, Extra: model.FeedExtra{KeepFilterEntryRules: "EntryURL=(?i)example\nEntryTitle=(?i)Test"}}, &model.Entry{URL: "https://example.com", Title: "Some Example"}, &model.User{}, true},
		// Test cases for merged user and feed KeepFilterEntryRules
		{&model.Feed{ID: 1, Extra: model.FeedExtra{KeepFilterEntryRules: "EntryURL=(?i)website"}}, &model.Entry{URL: "https://example.com", Title: "Some Title"}, &model.User{KeepFilterEntryRules: "EntryTitle=(?i)title"}, true},    // User rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{KeepFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://example.com", Title: "Some Other"}, &model.User{KeepFilterEntryRules: "EntryTitle=(?i)title"}, true},    // Feed rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{KeepFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://different.com", Title: "Some Other"}, &model.User{KeepFilterEntryRules: "EntryTitle=(?i)title"}, false}, // Neither rule matches
		{&model.Feed{ID: 1, Extra: model.FeedExtra{KeepFilterEntryRules: "EntryURL=(?i)example"}}, &model.Entry{URL: "https://example.com", Title: "Some Title"}, &model.User{KeepFilterEntryRules: "EntryTitle=(?i)title"}, true},    // Both rules would match
	}
...
func TestIsBlockedGlobally(t *testing.T) {
	...
	if blockedGlobally(&model.Entry{Title: "Test Entry", Date: time.Date(2020, 5, 1, 0o5, 0o5, 0o5, 0o5, time.UTC)}) {
	...
	if blockedGlobally(&model.Entry{Title: "Test Entry", Date: time.Now().Add(-2 * time.Hour)}) {
